...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String KEY_ID2 = "subjects";
    ...
    public void addUser(String name, String hobby, String city, String s) {
    ...
    public ArrayList<UserModel> getAllUsers() {
        ...
        if (c.moveToFirst()) {
            ...
            do {
                ...
                //getting user hobby where id = id from user_Boit table
    ...
    public long insertData(String t1, String t2, String t3, String t4, String t5, String t6, String t7) {
        return 0;
    }
}