...
public class StudentAdapter extends BaseAdapter {
    ...
    public StudentAdapter(Context context, ArrayList<UserModel> userModelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_lv, null, true);
        ...
        holder.tvhobby.setText("Grade: "+userModelArrayList.get(position).getHobby());

        holder.tvcity.setText("Marks: "+userModelArrayList.get(position).getCity());
